...
call "%%~dp0canonical_path_if_ndef.bat" TACKLEBAR_PROJECT_ROOT                  "%%~dp0.."
...
call "%%~dp0canonical_path_if_ndef.bat" PROJECT_OUTPUT_ROOT                     "%%TACKLEBAR_PROJECT_ROOT%%/_out"
call "%%~dp0canonical_path_if_ndef.bat" PROJECT_LOG_ROOT                        "%%TACKLEBAR_PROJECT_ROOT%%/.log"

call "%%~dp0canonical_path_if_ndef.bat" TACKLEBAR_PROJECT_INPUT_CONFIG_ROOT     "%%TACKLEBAR_PROJECT_ROOT%%/_config"
call "%%~dp0canonical_path_if_ndef.bat" TACKLEBAR_PROJECT_OUTPUT_CONFIG_ROOT    "%%PROJECT_OUTPUT_ROOT%%/config/tacklebar"

rem retarget externals of an external project

call "%%~dp0canonical_path_if_ndef.bat" CONTOOLS_PROJECT_EXTERNALS_ROOT         "%%TACKLEBAR_PROJECT_EXTERNALS_ROOT%%"
call "%%~dp0canonical_path_if_ndef.bat" TACKLELIB_PROJECT_EXTERNALS_ROOT        "%%TACKLEBAR_PROJECT_EXTERNALS_ROOT%%"
call "%%~dp0canonical_path_if_ndef.bat" SVNCMD_PROJECT_EXTERNALS_ROOT           "%%TACKLEBAR_PROJECT_EXTERNALS_ROOT%%"
...
if %NO_GEN%0 EQU 0 (
  call "%%CONTOOLS_BUILD_TOOLS_ROOT%%/mkdir_if_notexist.bat" "%%TACKLEBAR_PROJECT_OUTPUT_CONFIG_ROOT%%" || exit /b
)
...
"%%TACKLEBAR_PROJECT_EXTERNALS_ROOT%%/tacklelib/__init__/__init__.bat" -no_load_user_config || exit /b
