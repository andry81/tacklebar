...
set "MOUNTED_DRIVE_LIST_FILE_NAME_TMP=mounted_drives.lst"
set "MOUNTED_DRIVE_LIST_FILE_TMP=%SCRIPT_TEMP_CURRENT_DIR%\%MOUNTED_DRIVE_LIST_FILE_NAME_TMP%"
set "SUBSTED_DRIVE_LIST_FILE_NAME_TMP=substed_drives.lst"
set "SUBSTED_DRIVE_LIST_FILE_TMP=%SCRIPT_TEMP_CURRENT_DIR%\%SUBSTED_DRIVE_LIST_FILE_NAME_TMP%"
...
call "%%TACKLEBAR_PROJECT_ROOT%%/tools/shell_copy_file_log.bat" "%%MOUNTED_DRIVE_LIST_FILE_TMP%%" "%%PROJECT_LOG_DIR%%/%%MOUNTED_DRIVE_LIST_FILE_NAME_TMP%%"
...
call "%%TACKLEBAR_PROJECT_ROOT%%/tools/shell_copy_file_log.bat" "%%TACKLEBAR_BUTTONBAR_SUBST_DRIVE_MENU_TMP%%" "%%PROJECT_LOG_DIR%%/%%BUTTONBAR_SUBST_DRIVE_FILE_NAME%%"
...
call "%%TACKLEBAR_PROJECT_ROOT%%/tools/shell_copy_file_log.bat" "%%TACKLEBAR_BUTTONBAR_UNSUBST_DRIVE_MENU_TMP%%" "%%PROJECT_LOG_DIR%%/%%BUTTONBAR_UNSUBST_DRIVE_FILE_NAME%%"
