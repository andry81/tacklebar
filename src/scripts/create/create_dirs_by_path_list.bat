...
) else set "CREATE_DIRS_FROM_LIST_FILE_TMP=%LIST_FILE_PATH%"
...
for /F "tokens=* delims="eol^= %%i in ("%CREATE_DIR_PATH%\.") do set "CREATE_DIR_PATH=%%~fi" & set "CREATE_DIR_PATH_IN_DIR=%%~dpi"
