...
(
  ...
  if %PROPS_FILTER_PATH_INDEX% EQU 0 (
    ...
    mkdir "%PROPS_INOUT_PATH_DIR%" 2>nul || "%SystemRoot%\System32\robocopy.exe" ( "%SystemRoot%\System32\robocopy.exe" /CREATE "%EMPTY_DIR_TMP%" "%PROPS_INOUT_PATH_DIR%" >nul ) else type 2>nul || (
